...
export const metadata = {
  title: "Privacy Policy | GrowthApp",
  description:
    "Learn how GrowthApp collects, uses, and protects your personal information when you use our land investment platform.",
  alternates: {
  ...
  openGraph: {
    title: "Privacy Policy | GrowthApp",
    description: "How GrowthApp handles and protects your personal data.",
...
const sections = [
  {
    ...
    content: (
      <p>
        At GrowthApp, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose,
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mt-4">To exercise these rights, please contact us at <a href="mailto:privacy@growthapp.com" className="text-amber-700 hover:underline">privacy@growthapp.com</a>.</p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        GrowthApp, you consent to such transfers. We ensure appropriate safeguards are in place to protect your
      ...
      <>
        ...
        <div className="not-prose bg-emerald-50 border border-emerald-200 rounded-xl p-5">
          <p className="text-[#3D4D43] text-sm leading-relaxed">
            <strong className="text-[#0D1F1A]">Email:</strong> privacy@growthapp.com<br />
            <strong className="text-[#0D1F1A]">Address:</strong> 123 Investment Street, Lagos, Nigeria<br />
            <strong className="text-[#0D1F1A]">Phone:</strong> +234 123 456 7890
          </p>
        </div>
      </>
    ),
      ...
      <div className="max-w-4xl mx-auto px-6 py-16 sm:py-24">
        ...
        <div className="mt-14 pt-8 border-t border-stone-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex gap-4 text-sm text-[#5C6B63]">
            <Link href="/terms" className="hover:text-[#0D1F1A] transition-colors">Terms of Service</Link>
          </div>
        </div>
      </div>
    </div>
