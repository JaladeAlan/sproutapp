...
export const metadata = {
  title: "Terms of Service | GrowthApp",
  description:
    "Read GrowthApp's Terms of Service governing your use of our land investment platform in Nigeria.",
  alternates: {
  ...
  openGraph: {
    title: "Terms of Service | GrowthApp",
    description: "Terms and conditions governing use of the GrowthApp land investment platform.",
...
const sections = [
  {
    ...
    content: (
      <p>
        Welcome to GrowthApp. By accessing or using our platform, you agree to be bound by these Terms of Service.
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-4">To use certain features of GrowthApp, you must register for an account. You agree to:</p>
        <ul>
  ...
  },
  {
    ...
    content: (
      <p>
        Land investments carry inherent risks. GrowthApp does not guarantee any returns on investment.
  ...
  },
  {
    ...
    content: (
      <p>
        All content on GrowthApp, including text, graphics, logos, images, and software, is the property of
        GrowthApp or its licensors and is protected by copyright, trademark, and other intellectual property laws.
  ...
  },
  {
    ...
    content: (
      <p>
        GrowthApp is provided "as is" without warranties of any kind. We shall not be liable for any indirect,
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        through the platform. Your continued use of GrowthApp after such modifications constitutes your acceptance
      ...
      <>
        ...
        <div className="not-prose bg-amber-50 border border-amber-200 rounded-xl p-5">
          <p className="text-[#3D4D43] text-sm leading-relaxed">
            <strong className="text-[#0D1F1A]">Email:</strong> legal@growthapp.com<br />
            <strong className="text-[#0D1F1A]">Address:</strong> 123 Investment Street, Lagos, Nigeria
          </p>
        </div>
      </>
    ),
    ...
    <div className="min-h-screen bg-[#FDFAF5]" style={{ fontFamily: "'DM Sans', 'Helvetica Neue', sans-serif" }}>
      ...
      <div className="bg-[#0D1F1A] px-6 py-4 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2 text-white/70 hover:text-white transition-colors text-sm font-medium">
          <ArrowLeft size={15} /> Back to GrowthApp
        </Link>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16 sm:py-24">
        ...
        <header className="mb-14">
          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <span className="text-[#5C6B63] text-sm">Applies to all GrowthApp users</span>
          </div>
        ...
        <div className="mt-14 pt-8 border-t border-stone-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex gap-4 text-sm text-[#5C6B63]">
            <Link href="/privacy" className="hover:text-[#0D1F1A] transition-colors">Privacy Policy</Link>
          </div>
        </div>
      </div>
    </div>
