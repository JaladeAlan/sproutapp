    ...
    >
            ...
            {kycs.map((kyc, i) => (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-white/30 mt-0.5">{kyc.user.email}</p>
                </div>
                <p className="text-sm text-white/70">{kyc.full_name}</p>
                <p className="text-sm text-white/70 uppercase">{kyc.id_type?.replace("_", " ")}</p>
      ...
      {showModal && selectedKyc && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div
            className="relative w-full max-w-3xl max-h-[90vh] overflow-y-auto rounded-3xl border border-white/10 bg-[#0f2820] shadow-2xl"
            style={{ fontFamily: "'DM Sans', 'Helvetica Neue', sans-serif" }}
          >
            {/* Modal header */}
            <div className="flex items-start justify-between p-6 border-b border-white/10 sticky top-0 bg-[#0f2820] z-10">
              <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <button onClick={closeModal} className="w-8 h-8 rounded-lg bg-white/5 hover:bg-white/10 flex items-center justify-center text-white/50 hover:text-white transition-all">
                  <X size={16} />
                </button>
              </div>
            </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <section>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-white/5 rounded-xl p-4 border border-white/5">
                    ...
                    <p className="text-sm font-semibold text-white uppercase">{selectedKyc.id_type?.replace("_", " ")}</p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/5">
                    <p className="text-xs text-white/30 mb-1">ID Number</p>
                    <p className="text-sm font-semibold text-white font-mono">{selectedKyc.id_number}</p>
                  </div>
                </div>
              </section>
              ...
              {selectedKyc.rejection_reason && (
                <section>
                  <div className="flex items-center gap-2 p-4 rounded-xl border border-red-500/20 bg-red-500/10">
              ...
              {selectedKyc.status === "pending" && (
                <section className="space-y-4 pt-2">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 py-3.5 rounded-xl font-bold text-[#0D1F1A] transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-white/20 text-xs">or reject / request changes</span>
                    <div className="flex-1 h-px bg-white/10" />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      <RefreshCw size={15} /> Request Resubmit
                    </button>
                  </div>
                </section>
              )}
