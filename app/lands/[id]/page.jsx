...
import { ArrowLeft, MapPin, Layers, TrendingUp, ShieldCheck, Lock, X, AlertCircle } from "lucide-react";
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-10">
          ...
          <div className={`grid gap-3 mb-10 rounded-2xl overflow-hidden border border-white/10 ${images.length > 1 ? "grid-cols-2" : "grid-cols-1"}`}>
            {images.map((img, i) => (
              ...
              >
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0D1F1A]/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4">
        ...
        <div className="flex flex-wrap gap-3">
          <button
            ...
            className={`inline-flex items-center gap-2 px-7 py-3.5 rounded-xl font-bold text-[#0D1F1A] transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:scale-100`}
          ...
          {userUnits > 0 && (
            <button
              ...
              disabled={!user?.transaction_pin}
              className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl font-bold text-white border border-white/20 bg-white/5 hover:bg-white/10 transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
